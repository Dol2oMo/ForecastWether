...
extension SecondPageViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func configurationCell() {
        ...
        myTableView.register(UINib(nibName: UiNib.forcastTableViewCell, bundle: Bundle.main), forCellReuseIdentifier: UiNib.forcastTableViewCell)
        //header
        myTableView.register(UINib(nibName: UiNib.textHeaderTableViewCell, bundle: Bundle.main), forHeaderFooterViewReuseIdentifier: UiNib.textHeaderTableViewCell)
    }
